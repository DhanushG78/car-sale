...
export const Navbar = () => {
  ...
  // Avoid hydration mismatch by rendering a consistent server-side state (null or skeleton)
  // then updating after mount on the client.
  const authContent = mounted ? (
    <>
      <div className="hidden lg:flex items-center gap-8 font-black text-xs uppercase tracking-widest text-gray-500">
         ...
         {isSeller && <Link href="/#sell-form" className="hover:text-blue-600 transition-colors">Sell Car</Link>}
    ...
    // Skeleton or initial state that matches server exactly
